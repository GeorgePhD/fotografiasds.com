...
const iceandwinterGallery = document.querySelector('.images__container');

const fetchData = async () => {
    try {
        const response = await fetch('../js/iceandwinter/iceandwinter.json');
        if (!response.ok) {
