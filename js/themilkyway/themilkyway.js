const theMilkyWayGallery = document.querySelector(".images__container");

const fetchData = async () => {
    try {
        const response = await fetch('../js/themilkyway/themilkyway.json');
        if (!response.ok) {
